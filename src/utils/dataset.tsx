...
{label:"Persian/farsi", value:"fa",icon:'ir'},
{label:"Punjabi", value:"pa",icon:'pk'},
{label:"Ukranian", value:"uk",icon:'ua'},
{label:"Romanian", value:"ro",icon:'ro'},
{label:"Filipino/tagalog", value:"tl",icon:'ph'},
]
...
"welcmCreate":{
  "en": "Welcome to NEWSWORLD! Fill up the information",
  "fr": "Bienvenue sur NEWSWORLD ! Remplissez les informations",
  "de": "Willkommen bei NEWSWORLD! Füllen Sie die Informationen aus",
  "ar": "مرحبًا بك في NEWSWORLD! املأ المعلومات",
  "es": "¡Bienvenido a NEWSWORLD! Completa la información",
  "tr": "NEWSWORLD’e hoş geldiniz! Bilgileri doldurun",
  "nl": "Welkom bij NEWSWORLD! Vul de informatie in",
  "it": "Benvenuto su NEWSWORLD! Compila le informazioni",
  "ja": "NEWSWORLDへようこそ！情報を入力してください",
  "zh": "欢迎来到 NEWSWORLD！填写信息",
  "ko": "NEWSWORLD에 오신 것을 환영합니다! 정보를 입력하세요",
  "hi": "NEWSWORLD में आपका स्वागत है! जानकारी भरें",
  "pt": "Bem-vindo ao NEWSWORLD! Preencha as informações",
  "ru": "Добро пожаловать в NEWSWORLD! Заполните информацию",
  "sw": "Karibu NEWSWORLD! Jaza taarifa",
  "pl": "Witamy w NEWSWORLD! Wypełnij informacje",
  "id": "Selamat datang di NEWSWORLD! Isi informasi",
  "fa": "به NEWSWORLD خوش آمدید! اطلاعات را وارد کنید",
  "pa": "NEWSWORLD ਵਿੱਚ ਸੁਆਗਤ ਹੈ! ਜਾਣਕਾਰੀ ਭਰੋ",
  "uk": "Ласкаво просимо до NEWSWORLD! Заповніть інформацію",
  "ro": "Bine ai venit la NEWSWORLD! Completează informațiile",
  "tl": "Maligayang pagdating sa NEWSWORLD! Punan ang impormasyon"
},
